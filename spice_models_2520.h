...
inline SpiceBjtModel getSpiceBjtModel(const std::string &name) {
  // Order: Is, Ne, Bf, Br, Vaf, RB, RC, RE, CJE, CJC
  if (name == "SKA4693" || name == "BC414C")
    return {5.911e-15, 1.0, 394.1, 10.35, 44.95, 100.0, 1.0, 100.0, 0, 0};
  if (name == "TIS98")
    return {4.872e-15, 1.0, 96.00, 6.935,     100.0,
            100.0,     1.0, 100.0, 10.49e-12, 8.866e-12};
  if (name == "2N5087")
    return {7.373e-15, 1.0, 923.4, 3.745,   80.3,
            100.0,     1.0, 100.0, 5.0e-12, 14.76e-12};
  if (name == "2N3053")
    return {5.911e-15, 1.0, 394.1, 10.35,     44.95,
            100.0,     1.0, 100.0, 8.882e-12, 7.306e-12};
  if (name == "2N4036")
    return {1.0e-14, 1.0, 100.0, 1.0,      50.0,
            100.0,   1.0, 100.0, 10.0e-12, 5.0e-12};
